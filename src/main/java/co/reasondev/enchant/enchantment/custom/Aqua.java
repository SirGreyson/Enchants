...
public class Aqua extends CustomEnchant {

    public Aqua(int id, String name, int maxLevel) {
    ...
    public void handleItemEquip(ArmorEquipEvent e) {
        ...
        if (hasEnchant(e.getNewArmorPiece())) {
            e.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.WATER_BREATHING, Integer.MAX_VALUE, 0));
        }
    }
